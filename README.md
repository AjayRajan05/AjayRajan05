...
<table border="0">
  <tr>
    <td width="50%">
      ...
      <p>Computer Vision powered smart traffic optimization.</p>
      <p><b>Tech:</b> Python • OpenCV • Machine Learning</p>
    </td>
    <td width="50%">
      <h3>🐄 GauConnect 2.0</h3>
      <p>AI + Blockchain platform to protect indigenous cattle breeds.</p>
      <p><b>Tech:</b> AI • Blockchain • Firebase</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🎤 Voice AI for Farmers</h3>
      <p>Multilingual conversational AI helping farmers get advice.</p>
      <p><b>Tech:</b> Gemini API • NLP • STT/TTS</p>
    </td>
    <td width="50%">
      <h3>🧠 MedPro</h3>
      <p>AI-powered mental health platform for students.</p>
      <p><b>Tech:</b> AI Chatbot • React • Firebase</p>
    </td>
  </tr>
</table>
